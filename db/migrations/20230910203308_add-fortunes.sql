-- migrate:up
insert into "fortune" ("content") values
  ...
  ('Be on the lookout for coming evens; They cast their shadows beforehand.'), 
  ...
  ('Be tactfl; overlook your own opportunity.'), 
  ...
  ('You are a lover of wors; One day you will write a book.'), 
  ...
  ('Never upset the driver of the car you''re n; they''re the master of your destiny until you get home.'), 
  ...
  ('You are not judged by your efforts you put n; you are judged on your performance.'), 
  ('Rivers need springs.'), 
  ...
  ('It is not necessary to show others you have chane; the change will be obvious.'), 
